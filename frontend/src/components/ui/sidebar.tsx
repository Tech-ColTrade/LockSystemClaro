...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: como flex item, sin esto una tabla ancha infla el ancho de
        // toda la página (scroll horizontal del body y el contenido se mete
        // debajo del sidebar fijo). Con min-w-0, el overflow-x-auto interno de
        // cada tabla es quien scrollea.
